...
if(isset($_POST['update_btn'])) {
    $dish = $_POST['dish'];
    $price = $_POST['price'];
    $sql = "INSERT INTO  waffles_menu (dish,price) VALUE ('$dish','$price')";
    $query = mysqli_query($conn, $sql);
    if($query){
        header("location:waffles_menu.php");
        exit;
    }
}
if(isset($_POST['update_btn1'])) {
    $dish = $_POST['dish'];
    $price = $_POST['price'];
    $sql = "INSERT INTO  waffles_sandwiches_menu (dish,price) VALUE ('$dish','$price')";
    $query = mysqli_query($conn, $sql);
    if($query){
        header("location:waffles_menu.php");
        exit;
...
if(isset($_POST['update_btn2'])) {
    $dish = $_POST['dish'];
    $price = $_POST['price'];
    $sql = "INSERT INTO  waffles_baby_menu (dish,price) VALUE ('$dish','$price')";
    $query = mysqli_query($conn, $sql);
    if($query){
        header("location:waffles_menu.php");
        exit;
...
if(isset($_POST['update_btn3'])) {
    $dish = $_POST['dish'];
    $price = $_POST['price'];
    $sql = "INSERT INTO  waffles_toppings_menu (dish,price) VALUE ('$dish','$price')";
    $query = mysqli_query($conn, $sql);
    if($query){
        header("location:waffles_menu.php");
        exit;
...
if(isset($_POST['update_btn4'])) {
    $dish = $_POST['dish'];
    $price = $_POST['price'];
    $sql = "INSERT INTO  waffles_sides_menu (dish,price) VALUE ('$dish','$price')";
    $query = mysqli_query($conn, $sql);
    if($query){
        header("location:waffles_menu.php");
        exit;
...
<div class="menu_grid_layout">
    <div class="z-depth-1">
        <div>
            <h1><?=$msg?></h1>
            <div class="row">
                <form class="col s12 form_setup" method="post" action="waffles_menu.php">
                    <div class="row">
    ...
    <div class="table_padding">
        <h4 class="center"><b>Waffles</b></h4>
...
<div class="menu_grid_layout">
        ...
        <div>
            ...
            <div class="row">
                <form class="col s12 form_setup" method="post" action="waffles_menu.php">
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="dish1" type="text" class="validate" name="dish">
                            <label for="dish1">Dish</label>
                        </div>
                        <div class="input-field col s12">
                            <input id="price1" type="text" class="validate" name="price">
    ...
    <div class="table_padding">
        <h4 class="center"><b>Waffles Sandwiches</b></h4>
        <table class=" z-depth-1" style="border-radius: 10px;">
            <?php
...
<div class="menu_grid_layout">
    ...
    <div class="table_padding">
        <h4 class="center"><b>Baby Waffles</b></h4>
        <table class=" z-depth-1" style="border-radius: 10px;">
            <?php
...
<div class="menu_grid_layout">
    ...
    <div class="table_padding">
        <h4 class="center"><b>Waffles Toppings</b></h4>
        <table class=" z-depth-1" style="border-radius: 10px;">
            <?php
...
<div class="menu_grid_layout">
    ...
    <div class="table_padding">
        <h4 class="center"><b>Waffles Sides</b></h4>
        <table class=" z-depth-1" style="border-radius: 10px;">
            <?php
