...
if(isset($_POST['update_btn'])) {
    $dish = $_POST['dish'];
    $price = $_POST['price'];
    $sql = "INSERT INTO  rice_menu (dish,price) VALUE ('$dish','$price')";
    $query = mysqli_query($conn, $sql);
    if($query){
        header("location:rice_menu.php");
        exit;
    }
    else{
        $msg = "Failed";
...
<div class="menu_grid_layout">
    <div class="z-depth-1">
        <div>
            <h1><?=$msg?></h1>
            <div class="row">
                <form class="col s12 form_setup" method="post" action="rice_menu.php">
                    <div class="row">
